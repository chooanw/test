...
<body>
  ...
  <div id="error-container">
    ...
    <div class="terminal">
      ...
      <div class="message">
        <span class='prompt'><span class='user'>root</span><span class="at">@</span><span class="path">Chaeshoo</span>~<span class="caret">$</span> </span>
...
$(function() {
  $(".typed").typed({
    strings: [
      "ppppppp Netflixnya qaqa <br/>" + 
      "~<span class='caret'>$</span> Aping-san jelek <br/> ^1" +
      "~<span class='caret'>$</span> Relucia Jelek <br/> ^200" +
      "~<span class='caret'>$</span> Ica big jelek <br/> ^200" +
      "~<span class='caret'>$</span> Pepar jelek <a href='#'></a>"
    ],
    showCursor: true,
    cursorChar: '_',
    autoInsertCss: true,
